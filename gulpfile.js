...
gulp.task('watch', gulp.series(rimraf('out'), ['compile'], gulp.parallel(() => gulp.watch([compile.frontendSource, compile.frontendResources, compile.frontendSass], compile.compileFrontEnd()), () => gulp.watch([compile.serverSources, compile.serverResources], compile.compileServer()))));
